...
import 'list_prescripcion_consult_model.dart';
export 'list_prescripcion_consult_model.dart';

class ListPrescripcionConsultWidget extends StatefulWidget {
  const ListPrescripcionConsultWidget({
    super.key,
  ...
  @override
  _ListPrescripcionConsultWidgetState createState() =>
      _ListPrescripcionConsultWidgetState();
}

class _ListPrescripcionConsultWidgetState
    extends State<ListPrescripcionConsultWidget> {
  late ListPrescripcionConsultModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ListPrescripcionConsultModel());
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<PatientRecord>(
      ...
      builder: (context, snapshot) {
        ...
        final listPrescripcionConsultPatientRecord = snapshot.data!;
                              ...
                              child: StreamBuilder<List<PrescripcionesRecord>>(
                                stream: queryPrescripcionesRecord(
                                  queryBuilder: (prescripcionesRecord) =>
                                    ...
                                    'idu_paciente',
                                    isEqualTo:
                                        listPrescripcionConsultPatientRecord
                                            .reference.id,
                                  ),
                                ),
                                builder: (context, snapshot) {
