...
import 'register_prescripcion_model.dart';
export 'register_prescripcion_model.dart';

class RegisterPrescripcionWidget extends StatefulWidget {
  const RegisterPrescripcionWidget({
    super.key,
  ...
  @override
  _RegisterPrescripcionWidgetState createState() =>
      _RegisterPrescripcionWidgetState();
}

class _RegisterPrescripcionWidgetState
    extends State<RegisterPrescripcionWidget> {
  late RegisterPrescripcionModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => RegisterPrescripcionModel());
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<PatientRecord>(
      ...
      builder: (context, snapshot) {
        ...
        final registerPrescripcionPatientRecord = snapshot.data!;
                    ...
                    children: [
                                    ...
                                    Container(
                                      ...
                                      child: Padding(
                                        padding: const EdgeInsetsDirectional.fromSTEB(
                                            8.0, 8.0, 8.0, 0.0),
                                        child: Text(
                                          registerPrescripcionPatientRecord.idu,
                                          style: FlutterFlowTheme.of(context)
                                              .bodyMedium
                                              .override(
                                                fontFamily: 'Readex Pro',
                      ...
                      Padding(
                        ...
                        child: FFButtonWidget(
                          onPressed: () async {
                            await PrescripcionesRecord.collection
                                .doc()
                                .set(createPrescripcionesRecordData(
                                  titulo: _model.nameTFController.text,
                                  fechaPublicacion:
                                      _model.fechaAnalisisController.text,
                                  descripcion:
                                      _model.descripcionController.text,
                                  iduPaciente: registerPrescripcionPatientRecord
                                      .reference.id,
                                ));
